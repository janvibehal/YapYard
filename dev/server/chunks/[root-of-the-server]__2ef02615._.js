...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Post$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Post.js [app-route] (ecmascript)"); // Assuming Post import path is correct
(()=>{
...
async function POST(req) {
    try {
        ...
        // CRITICAL FIXES: Use the correct keys ('mediaFile') and getAll() for arrays
        ...
        if (mediaFiles.length > 0) {
            for(let i = 0; i < mediaFiles.length; i++){
                ...
                // Check if item is a File object and has content
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ef02615._.js.map